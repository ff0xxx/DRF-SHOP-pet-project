...
class SellerProductView(APIView):
    ...
    @extend_schema(
        ...
        description="This endpoint allows a seller to deletee a product",
        tags=tags
    )
    def delete(self, request, *args, **kwargs):
        ...
        if not product:
            ...
            return Response(data={'message': 'Access is Denied'}, status=403)
        product.delete()
        return Response(data={'message': 'Product deleted successfully'}, status=204)
...
class SellerOrdersView(APIView):
    ...
    @extend_schema(
        ...
        summary='Seller Ordes Fetch',
        description='This endpoint returns all orders for particular seller',
        tags=tags,
    )
...
class SellerOrderItemView(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        if not order:
            return Reponse(data={'message': 'Order does not exist!'}, status=404)
        orderitems = OrderItem.objects.filter(order=order, product__seller=seller)
